...
- **Zapečaćena imena** — Davidovo, ime grada, Katarinino u naraciji, Jovanino van
  dozvoljenih mesta.
- **Nove scene, novi likovi, nova mesta radnje.**
- **Deo 0 — šest odgovora o knjizi** (`FINALNI_PROLAZ_PRAVILA.md`), odgovoreno
  05.08.2026.
...
# 2 — LIKOVI: ŠTA SE NE DIRA

| lik | odluka |
|---|---|
| **Nataša** | **Ne dirati nigde gde se pojavljuje.** Njena ravnost je funkcija, ne problem. Svaki prolaz poželi da joj „doda dubinu" — ne dodaje se. |
...
Ne brišu se, ne skraćuju, ne prepisuju.

### I — Susret
- Poslednja rečenica poglavlja.
- **ODBAČENO (odluka autora):** varijanta u kojoj Davida kod kuće čeka ručak.
  Razlog: u I se **ne sme rešiti da živi s Katarinom** — to je raspored informacije
  koji pripada kasnijim poglavljima.
- **ODBAČENO:** varijanta s poslom („Trebalo je da budem na poslu u dva").
- **ODBAČENO pre nego što je stiglo do autora:** dopuna u kojoj David posle piše
  Katarini da ga je zadržao posao — to bi bila **prava laž**, a zaključano je da
  David ne laže nego izostavlja.

### II — Pukotina
- Andrijanina replika o izostavljanju (vidi 2).
- Brijač na kraju poglavlja.
...
- *„s njom se nije vodila ljubav, s njom se ratovalo"*.
...
- Oprana šolja — zaštićeno ponavljanje kroz V i IX.
- Jovanino *„Dobro."*
- Tag *„ona pod šeširom"*.
- Red 57 *„sto malih jutara"* — zatvoreno ranijom odlukom.
- *„zvao milošću"* — razmotreno kao imenovana emocija i **zadržano**: ne imenuje
...
- **Red 35:** *„Postoji samo jedna ona o kojoj se zove usred srede."* — predlog reza
  **odbijen 23.08.2026, odluka autora.** Razlog: sreda drži okvir poglavlja („Bila
  je sreda" na početku, „Napolju je bila sreda, i dalje" na kraju), a ta rečenica je
  jedino mesto gde poziv ulazi u taj okvir.
- **Kvota 2.2 (dostojanstvo) — zatvorena kao nepopunjiva u VI**, 23.08.2026.
...
# 4 — REZERVISANA MESTA I MEHANIZMI

### Formula „to je bila cela X / to je bilo najgore"
Dozvoljeno **najviše 2–3 puta u celoj knjizi.**
...
Rezervisan **samo za par II i IX.** III, IV, V, VI, VII, VIII se **ne popunjavaju**
...
poglavlje, napiše sledeće, pa se traži „pročitaj sve do tog poglavlja" — i svaki put
nešto padne, pa se otključava. **Uzrok nije u poglavljima nego u meri: mera je rasla
brže od rukopisa.** Deo 0, pet dugova knjige i pravila H7/N/O upisani su 21.08., a
I–IV su zaključani ranije, po meri koja je merila samo rečenicu i poglavlje. Sve
zaključano pod starom merom **mora** pasti pod novom — to nije nalaz nego artefakt
zadatka. Zahtev „pročitaj sve do ovog poglavlja" garantuje nalaz, uvek, beskonačno.

**Jedan jedini prolaz kroz I–V ostaje zakazan za trenutak kad IX bude napisan** —
tada mera prestaje da raste, jer nema više poglavlja koje bi je promenilo.

### Pravilo P — dug se plaća unapred, nikad unazad
Ako se u kasnijem poglavlju vidi da nešto nije postavljeno u ranijem, **to se ne
rešava u ranijem.** Rešava se tamo gde je nađeno. Nađeno ide u registar propuštenog,
ne u stariji fajl.
...
**napisana rečenica**. **Poglavlje se ne zatvara ako su sve unete izmene rezovi.**
Nijedan prepis znači da poglavlje nije pročitano dovoljno duboko — to je nalaz o
čitanju, ne o tekstu.

### PODELA VII — knjiga ima devet poglavlja
Stari VII je bio **5.896 reči — 38% cele knjige**, duže od prva četiri zajedno.
Podeljen je na šavu koji je već postojao u tekstu.

| staro | novo | reči |
|---|---|---|
| VII (1. deo) | **VII — Beli grad** | 2.190 |
| VII (2. deo) | **VIII — Kukavica** | 3.709 |
| VIII — Ćebence | **IX — Ćebence** | 1.573 |

**Nijedna rečenica nije promenjena podelom.** Zapisi stariji od 23.08.2026. koji
kažu „VIII" misle na **Ćebence (danas IX)**.

### D2 — dodir spolja: plaća se u IX, i nigde drugde
**VII i VIII se dešavaju pre I**, pa David još nije sreo starca iz I i **ne zna za
limarsku radionicu u Belom gradu.** Jedino poglavlje čija je sadašnjost posle I
jeste IX. Ne predlagati radionicu za VII ili VIII — hronologija to ne dopušta.

### Ceduljica u džepu — razrešeno
Papir koji David napipa u VIII **nije dodir spolja nego Katarina.** Ona ga je
stavila u kaput ujutru, pre polaska; IX to potvrđuje („Njen rukopis… Kaput je visio
u hodniku od jutra"). **To je jedini sopstveni čin koji Katarina ima u celoj
knjizi** — ne pripisivati ga nikom drugom i ne otvarati ponovo.

---

# 6 — ŠTA JE OD OVOGA NAJČEŠĆE KRŠENO

Redosled po učestalosti, iz istorije rada:

1. **Andrijanina replika u II** — svaki prolaz je vidi kao objašnjavanje.
2. **Nataša** — svaki prolaz joj hoće dubinu.
