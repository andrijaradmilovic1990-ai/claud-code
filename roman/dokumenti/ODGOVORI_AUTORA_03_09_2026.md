# ODGOVORI AUTORA — 03.09.2026

> **Šta je ovo.** Autorov materijal, dat u razgovoru 03.09.2026, na pitanja postavljena
> pošto je obrisan `PLAN_RASTA.md`. **Ovo nije plan i nije analiza — ovo je izvor.**
> Sve u ovom fajlu je autorovo znanje o svojim ljudima, a knjiga ga danas najvećim delom
> nema.
>
> **Sprat:** odmah ispod `POENTA_KNJIGE.md`. Kad se neki dokument s ovim sukobi —
> **važi ovaj fajl**, jer je noviji i jer je autorov.
>
> **Šta se s njim NE radi:** ne piše se ni jedna rečenica po njemu dok autor ne kaže gde
> šta ide. Ovo je materijal, ne spisak poteza.

---

## 1 — Šta ostaje čitaocu na kraju

**Autor: ne zna.** Ostaje otvoreno i **ne izmišlja se umesto njega.**

---

## 2 — ⚑ JOVANA: ON ZNA. — *ovo obara `POENTA_KNJIGE.md`*

**Autorov odgovor, doslovno u sadržaju:**

> **On zna šta mu je Jovana.** Gleda je kao sestru i **nikad sebi nije dozvolio da je gleda
> drugačije.** Bilo je trenutaka kad je popustio, pa se povratio i rekao **ne** — i to
> **zato što je nju voleo najviše od njih sve tri** i nije želeo da joj se nešto desi.

**Osa knjige nije neznanje nego zabrana.** `POENTA_KNJIGE.md` danas stoji na rečenici
*„nikad sebi nije dozvolio da zna šta mu je ona. Ona zna. On ne. To neznanje je knjiga."*
**To je netačno po autoru** — i tekst je oduvek bio na autorovoj strani:

- `Pariz` (6): *„jedino što sam želeo sedelo je pored mene… sve troje ostalo bi preživelo
  da ga dotaknem, a ona ne."* — čovek koji tačno zna.
- `Krv` (4): *„znao sam tada… da bih za nju spalio grad."*
- `Kukavica` (15): ne odgovara — **bira**, ne luta.

**Fajl `POENTA_KNJIGE.md` menja samo autor. Do njegove reči stoji ovaj zapis kao nalaz.**

---

## 3 — Posle `Kukavice` se više nisu videli ni čuli

Posle one noći u Belom gradu, kad ga je poljubila i on rekao **ne**, otišao je tog dana i
**od tada nema nijednog kontakta.** On preko **Andrijane** zna kako je ona; ona preko
Andrijane zna kako je on. **Ništa drugo.**

*(Knjiga to danas nosi jednom rečenicom u `Ćebencetu`: „Pita za tebe nekad.")*

---

## 4 — Čega se David boji

**Da se dva sveta ponovo sudare.**

- **Svet s Katarinom:** miran, šašav život, gde mu je najveća briga da špagete ne zagore.
- **Svet Andrijane, Nataše i Jovane:** njegovi možda omiljeni ljudi — **ali oni sa sobom
  vuku ostatak sveta koji je davno napustio.** Taj svet više ne želi. Presekao je.
  **Knjiga ga je naterala da učestvuje** zbog onoga što se desilo.

**Odluka o Jovani, autorovim rečima:** *ne stavljam tačku.* Ne želi da je povredi tako što
bi joj dao mogućnost za bilo šta, **jer je ona sve ili ništa.**
- **„sve"** = vraća ga u stari svet.
- **„ništa"** = ona nema ništa.

Zato ostaje bez tačke, a on se vraća svom normalnom svetu s Katarinom, gde gradi porodicu —
**jer je shvatio da ne može da bude polovičan.**

---

## 5 — Kraj: i izgubio i platio pa ostao

**Oba.** I uz to, **element koji knjiga danas nema:**

> **Jovana nikad nije znala zašto je on zapravo otišao pre dvanaest godina — i u ovoj knjizi
> ona to, otprilike, saznaje.**

**Nije glavna tema, ali u jednom trenutku jeste.** *(Gde, kako i od koga — nije rečeno.
Pitanje otvoreno.)*
...
- Ima **sestru** *(pominje se u `Nestanku` — pakuje se za vikend kod nje)* i **mlađeg brata.**
- **Nije iz tog grada.** Doselila se — **pobegla iz malog grada na jugu zemlje, od porodice,
  da krene nov život.**
- Tu je, **u fabrici**, upoznala Davida.
- **⚑ Ogledalo koje knjiga danas ne koristi:** *„interesantno je i on je pre dvanaest godina
  uradio isto to — otišao u mali grad da krene nov život."* **Ona i on su isti potez, s
  dvanaest godina razmaka.**
- **Šta hoće za pet godina:** porodicu, adresu, brak, venčanje, prsten.
- **Šta je dobila do sada:** samo **adresu** — počeli su da žive zajedno.
  **Prebivalište još nije prebacila na njegovu adresu.** *(To je sat iz `Pariza` i `Ćebenceta`.)*

---

## 7 — BRAT

- **Brat od tetke.** Stariji **oko devet godina.**
- **Jako pametan, jako elokventan.**
- Zajedno: **fudbal, crtanje, spremanje** *(kuvanje)*.
- **Autor se ne seća nijednog konkretnog dana** i nijedna scena mu ne prolazi kroz glavu.
  **Scena se ne izmišlja.** Ako se piše, piše se **iz navike, ne iz dana.**

---

## 8 — MAJKA — ⚑ najveći neiskorišćen materijal u celoj knjizi

**Živa je i izlečila se.**

**David i dan-danas živi s njom** — on u **gornjoj kući s Katarinom**, ona u **donjoj kući**,
**u istom dvorištu.** Porodice žive.

**Autorovim rečima: „sve je došlo na svoje mesto. Sve je sigurno i lepo."**

> **Nalaz:** ovo je stanje sadašnjosti, a **knjiga ga ne pokazuje nijednom rečenicom.**
> Danas se sadašnjost čita kao čovek sam u kafiću u tuđem gradu.

---

## 9 — ČOVEK U KAPUTU *(`Maska`)*

**Autor nije siguran o kome je reč.** Znači: **taj lik nije njegov** — ušao je u tekst u
sesiji pisanja `Maske`, ne iz autorovog materijala. **Tema se otvara posebno; do tada se
ništa oko njega ne gradi.**
